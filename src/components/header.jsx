      ...
      <nav className="relative max-w-7xl w-full flex flex-wrap md:grid md:grid-cols-12 basis-full items-center px-4 md:px-8 mx-auto">
        <div className="md:col-span-3">
          <Link
            ...
            href="/"
            aria-label="BlogSite">
            <h1 className="font-black tracking-wider">BLogSite</h1>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-x-1 md:gap-x-2 ms-auto py-1 md:ps-6 md:order-3 md:col-span-3">
          ...
          <AddBlog
            title="Add New Blog"
            description="Add Article, make sure you save change">
            <Button className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl border border-transparent bg-lime-400 text-black hover:bg-lime-500 focus:outline-none focus:bg-lime-500 transition disabled:opacity-50 disabled:pointer-events-none">
              Add Blog
            </Button>
          </AddBlog>
        ...
        <div
          id="hs-navbar-hcail"
          className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:flex gap-2 justify-center md:w-auto md:basis-auto md:order-2 md:col-span-6"
            ...
            <div
              ...
              <div>
                <Link
                  href={nav.path}
                  aria-current="page"
                  className={`${pathname === nav.path ? active : inActive}`}>
                  {nav.title}
                </Link>
              </div>
            </div>
